...
if (!is.na(strtoi(Sys.getenv("SPECIES_LEVEL")))) {
    Species_ls$occs <- Species_ls[names(Species_ls$occs) == SPECIES]
	message(paste0("Reduced GBIF species list to", length(Species_ls$occs)))
}
